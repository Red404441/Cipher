...
In plain terms: you are free to use, modify, and distribute this software. However, if you share a modified version, you must also make your source code available under the same license. You cannot take this code, close it up, and distribute it as proprietary software.
